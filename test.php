...
if ($response->finishReason === "stop") {
    $conversation->addMessage(new Message(Role::Assistant, $response->data['choices'][0]['message']['content'], $response->data['choices'][0]['message']['reasoning_content'] ?? null, $response->usage));
